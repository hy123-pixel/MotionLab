...
@interface MLTableRefreshLabelView()


@end

@implementation MLTableRefreshLabelView {
    UILabel *titleLabel;
}
...
-(void)setUp
{
    ...
    titleLabel.textColor = [MLGlobalMethod uiColorFromHexString:@"666666"];
...
- (CGFloat)titleWidth
{
    ...
    CGFloat width = [MLGlobalMethod getStringWidth:titleLabel.text withRect:self.frame attributes:attributes];
