...
@interface MLTableRefreshCurveLayer ()
...
@implementation MLTableRefreshCurveLayer
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.strokeColor = [MLGlobalMethod uiColorFromHexString:@"3c76ff"].CGColor;
