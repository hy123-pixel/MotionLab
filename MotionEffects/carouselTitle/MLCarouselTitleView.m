...
@implementation MLCarouselTitleView
...
- (CGFloat)getTitleWidth
{
    ...
    CGFloat width = [MLGlobalMethod getStringWidth:_title withRect:self.frame attributes:attributes];
