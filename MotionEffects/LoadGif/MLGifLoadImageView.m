...
@interface MLGifLoadImageView ()
{
    int tmp;
}
@property (nonatomic)        NSUInteger      currentFrameIndex;
@property (nonatomic,strong) MLGifLoadImage *animatedImage;
...
@implementation MLGifLoadImageView {
...
-(void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[MLGifLoadImage class]] && image.images) {
        ...
        self.animatedImage = (MLGifLoadImage *)image;
    }else{
...
-(void)setAnimatedImage:(MLGifLoadImage *)animatedImage
{
