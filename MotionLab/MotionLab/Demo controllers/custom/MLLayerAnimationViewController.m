//
//  MLLayerAnimationViewController.m
//  AnimationLearn
//
...
#import "MLLayerAnimationViewController.h"

@interface MLLayerAnimationViewController ()<CAAnimationDelegate>

@end

@implementation MLLayerAnimationViewController
...
- (void)addAnimationToLayerWithMode:(MLAnimatinType)mode endPoint:(CGPoint)endPoint
{
    NSArray *subLayers = [self.view.layer sublayers];
    CALayer *animationLayer = [subLayers lastObject];
    
    if (MLAnimatinTypeBasic == mode) {
    ...
    } else if (MLAnimatinTypeKeyFrame == mode) {
    ...
    } else if (MLAnimatinTypeKeyFramePath == mode) {
...
- (void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event
{
    ...
    if (animation) {
        ...
        NSInteger mode = MLAnimatinTypeKeyFramePath;
